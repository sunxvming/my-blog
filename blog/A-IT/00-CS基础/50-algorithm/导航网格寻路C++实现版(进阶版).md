...
蓝色的线代表寻路的路径
* 包含两个嵌套多边形的地图
![](http://sxm-upload.oss-cn-beijing.aliyuncs.com/imgs/微信截图_20191202105843.png)
* 根据场景资源生成的地图
![](http://sxm-upload.oss-cn-beijing.aliyuncs.com/imgs/微信截图_20191202104737.png)
![](http://sxm-upload.oss-cn-beijing.aliyuncs.com/imgs/微信截图_20191202105547.png)
![](http://sxm-upload.oss-cn-beijing.aliyuncs.com/imgs/微信截图_20191202105652.png)
