 ...
 - **blog/**
   ...
   - **IT/**
     - **00-CS基础/**
       ...
       - **00-数字电子/**
         - [数字电子技术(第十一版)--Floyd](./blog/IT/00-CS基础/00-数字电子/数字电子技术(第十一版)--Floyd.md)
         - [数字电子技术基础(第六版)--阎石](./blog/IT/00-CS基础/00-数字电子/数字电子技术基础(第六版)--阎石.md)
       - **10-组成原理&体系结构/**
     ...
     - **10-编程语言/**
       - **c.c++/**
         ...
         - **c++笔记/**
           ...
           - [11.C++多文件编程](./blog/IT/10-编程语言/c.c++/c++笔记/11.C++多文件编程.md)
       ...
       - **go/**
         - [0-c语言中文网-Go语言入门教程](./blog/IT/10-编程语言/go/0-c语言中文网-Go语言入门教程.md)
         - [1-极客时间-Go语言第一课](./blog/IT/10-编程语言/go/1-极客时间-Go语言第一课.md)
         - [2-Go语言项目开发实战](./blog/IT/10-编程语言/go/2-Go语言项目开发实战.md)
         ...
         - **web框架/**
           - [手把手带你写一个Web框架](./blog/IT/10-编程语言/go/web框架/手把手带你写一个Web框架.md)
           - **goframe/**
       ...
       - **python/**
         ...
         - **book/**
           - [Modern-Python-Cookbook-Second-Edition](./blog/IT/10-编程语言/python/book/Modern-Python-Cookbook-Second-Edition.md)
         - **python/**
       - **rust/**
         - [Rust编程第一课](./blog/IT/10-编程语言/rust/Rust编程第一课.md)
         - [学习资源](./blog/IT/10-编程语言/rust/学习资源.md)
     - **20-linux/**
       ...
       - **docker/**
         ...
         - **docker/**
       - **shell/**
         - [1-list](./blog/IT/20-linux/shell/1-list.md)
     - **30-database/**
       - **Elasticsearch/**
     ...
     - **40-tools/**
       ...
       - **编辑器/**
         - [emeditor](./blog/IT/40-tools/编辑器/emeditor.md)
         ...
         - **vscode/**
           ...
           - [vscode-rust](./blog/IT/40-tools/编辑器/vscode/vscode-rust.md)
     ...
     - **50-应用方向/**
       ...
       - **区块链/**
         - [web3](./blog/IT/50-应用方向/区块链/web3.md)
       ...
       - **后端/**
         ...
         - **php/**
           - [Composer](./blog/IT/50-应用方向/后端/php/Composer.md)
           - [PHP-FPM](./blog/IT/50-应用方向/后端/php/PHP-FPM.md)
           - [apple支付](./blog/IT/50-应用方向/后端/php/apple支付.md)
           - [aws服务的php接口](./blog/IT/50-应用方向/后端/php/aws服务的php接口.md)
           - [google支付](./blog/IT/50-应用方向/后端/php/google支付.md)
           - [nginx](./blog/IT/50-应用方向/后端/php/nginx.md)
           - [nginx高可用性](./blog/IT/50-应用方向/后端/php/nginx高可用性.md)
           - [php中的cookie和session的使用](./blog/IT/50-应用方向/后端/php/php中的cookie和session的使用.md)
           - [php常见错误](./blog/IT/50-应用方向/后端/php/php常见错误.md)
           - [php数组占用过多内存空间](./blog/IT/50-应用方向/后端/php/php数组占用过多内存空间.md)
           - [php的mysql驱动](./blog/IT/50-应用方向/后端/php/php的mysql驱动.md)
           - [php面向对象代码片段](./blog/IT/50-应用方向/后端/php/php面向对象代码片段.md)
           - [wordpress的一些实用插件](./blog/IT/50-应用方向/后端/php/wordpress的一些实用插件.md)
           - [代码片段](./blog/IT/50-应用方向/后端/php/代码片段.md)
           - [查看php错误日志](./blog/IT/50-应用方向/后端/php/查看php错误日志.md)
           - [苹果登录支付](./blog/IT/50-应用方向/后端/php/苹果登录支付.md)
           - **code/**
           - **php框架/**
             - [laravel入门](./blog/IT/50-应用方向/后端/php/php框架/laravel入门.md)
             - [lavarel中使用redis](./blog/IT/50-应用方向/后端/php/php框架/lavarel中使用redis.md)
             - [lavarel依赖注入](./blog/IT/50-应用方向/后端/php/php框架/lavarel依赖注入.md)
             - [lavarel常用功能](./blog/IT/50-应用方向/后端/php/php框架/lavarel常用功能.md)
             - [lavarel框架](./blog/IT/50-应用方向/后端/php/php框架/lavarel框架.md)
             - [lavarel调试](./blog/IT/50-应用方向/后端/php/php框架/lavarel调试.md)
             - [单元测试](./blog/IT/50-应用方向/后端/php/php框架/单元测试.md)
             - [框架功能](./blog/IT/50-应用方向/后端/php/php框架/框架功能.md)
         - **中间件/**
     ...
     - **60-其他主题/**
       - **windows&mac/**
         ...
         - [解决浏览器打开本地md文件变成直接下载](./blog/IT/60-其他主题/windows&mac/解决浏览器打开本地md文件变成直接下载.md)
       - **标准/**
       ...
       - **软件工程/**
         ...
         - [项目工具](./blog/IT/60-其他主题/软件工程/项目工具.md)
